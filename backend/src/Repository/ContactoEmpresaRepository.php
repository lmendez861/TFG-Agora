 ...
 * Relaciones: Conecta con App/Entity/ContactoEmpresa.
 */
...
/**
 * @extends ServiceEntityRepository<ContactoEmpresa>
 */
class ContactoEmpresaRepository extends ServiceEntityRepository
{
    /**
    ...
    {
        parent::__construct($registry, ContactoEmpresa::class);
    }
}

...
### Google Cloud Compute Engine con Docker Compose

Se deja preparado un despliegue completo para VM Ubuntu en Compute Engine:
...
Esta es la opcion mas alineada con un despliegue real de Agora sin rehacer la aplicacion hacia servicios serverless.

La guia paso a paso queda en [despliegue-google-cloud.md](./despliegue-google-cloud.md).

### GitHub Codespaces para demo externa
...
### Oracle Cloud Always Free con Docker Compose
